...
os.environ["TWBENCH_CACHE_HOME"] = (
    TWBENCH_CACHE_HOME  # Set the environment variable, in case it wasn't.
)
os.makedirs(TWBENCH_CACHE_HOME, exist_ok=True)

# Check if cache is flag is set to force download
TWBENCH_FORCE_DOWNLOAD = os.getenv("TWBENCH_FORCE_DOWNLOAD", "false").lower() in (
    "yes",
    "true",
    "t",
    "1",
