...
zword* kiiwi_ram_addrs                  (int*);
char** kiiwi_intro_actions              (int*);
int   kiiwi_victory                     (void);
char* kiiwi_clean_observation           (char*);
int   kiiwi_game_over                   (void);
int   kiiwi_get_num_world_objs          (void);
int   kiiwi_get_self_object_num         (void);
int   kiiwi_get_moves                   (void);
short kiiwi_get_score                   (void);
int   kiiwi_max_score                   (void);
