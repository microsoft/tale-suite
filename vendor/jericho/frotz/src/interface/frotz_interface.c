...
void load_rom_bindings(char *story_file) {
  ...
  if (strcmp(md5_hash, "A61400439AA76F8FABA3B8F01EDD4A72") == 0) {
    ...
    ROM_IDX = KARN_;
  } else if (strcmp(md5_hash, "6C8A04EC6ADFF4A4CAB98E89D87A19D8") == 0) {
    ROM_IDX = KIIWII_;
  } else if (strcmp(md5_hash, "DEF7D72AA9085CFF8988AACAA84613EB") == 0) {
    ROM_IDX = STARS_;
...
char* (*clean_observation_fns[]) (char* obs) = {
  ...
  kiiwi_clean_observation,
  stars_clean_observation,
  lily_clean_observation,
  froggy_clean_observation,
...
int (*get_self_object_num_fns[]) (void) = {
  ...
  kiiwi_get_self_object_num,
  stars_get_self_object_num,
  lily_get_self_object_num,
  froggy_get_self_object_num,
...
int (*get_num_world_objs_fns[]) (void) = {
  ...
  kiiwi_get_num_world_objs,
  stars_get_num_world_objs,
  lily_get_num_world_objs,
  froggy_get_num_world_objs,
...
int (*ignore_moved_obj_fns[]) (zword obj_num, zword dest_num) = {
  ...
  kiiwi_ignore_moved_obj,
  stars_ignore_moved_obj,
  lily_ignore_moved_obj,
  froggy_ignore_moved_obj,
...
int (*ignore_attr_diff_fns[]) (zword obj_num, zword attr_idx) = {
  ...
  kiiwi_ignore_attr_diff,
  stars_ignore_attr_diff,
  lily_ignore_attr_diff,
  froggy_ignore_attr_diff,
...
int (*ignore_attr_clr_fns[]) (zword obj_num, zword attr_idx) = {
  ...
  kiiwi_ignore_attr_clr,
  stars_ignore_attr_clr,
  lily_ignore_attr_clr,
  froggy_ignore_attr_clr,
...
void (*clean_world_objs_fns[]) (zobject* objs) = {
  ...
  kiiwi_clean_world_objs,
  stars_clean_world_objs,
  lily_clean_world_objs,
  froggy_clean_world_objs,
